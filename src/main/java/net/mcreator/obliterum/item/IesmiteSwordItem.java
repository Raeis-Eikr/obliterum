...
public class IesmiteSwordItem extends ObliterumModElements.ModElement {
	@ObjectHolder("obliterum:iesmite_sword")
	public static final Item block = null;
	public IesmiteSwordItem(ObliterumModElements instance) {
		super(instance, 30);
	}
