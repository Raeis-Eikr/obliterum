...
public class IesmiteBlockBlock extends ObliterumModElements.ModElement {
	@ObjectHolder("obliterum:iesmite_block")
	public static final Block block = null;
	public IesmiteBlockBlock(ObliterumModElements instance) {
		super(instance, 3);
	}
